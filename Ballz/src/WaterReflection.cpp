...
void WaterReflection::init(Ogre::Entity* water, int visibilityFlag)
{
	this->visibilityFlag = visibilityFlag;
	this->mEntity = water;
}

bool WaterReflection::start()
{
	...
	TextureUnitState* t = mat->getTechnique(0)->getPass(0)->getTextureUnitState("reflection");
	...
	t = mat->getTechnique(0)->getPass(0)->getTextureUnitState("reflection");
...
bool WaterReflection::update(Ogre::Real tslf)
{
