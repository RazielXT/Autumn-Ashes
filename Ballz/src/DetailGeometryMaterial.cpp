...
void DetailGeometryMaterial::reset()
{
	editVCMeshesDone.clear();
}

DetailGeometryMaterial::DetailGeometryMaterial()
{
	if (editVCMeshes.empty())
	{
		...
		//editVCMeshes["treeBunchTrunk.mesh"] = darkenBottomCenter;
...
void DetailGeometryMaterial::updateMaterial(Ogre::Entity* ent, Ogre::Vector3&, DetailGeometryInfo& info)
{
...
std::vector<Ogre::Material*> DetailGeometryMaterial::getGeneratedMaterials()
{
